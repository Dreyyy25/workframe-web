(function(){
  ...
  WFApp.icon = function(name,cls){
    var p = ICONS[name]||'';
    return '<svg class="wf-icon '+(cls||'')+'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'+p+'</svg>';
  };
